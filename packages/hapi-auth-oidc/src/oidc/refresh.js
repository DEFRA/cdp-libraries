 ...
 * Always returns a normalised token object.
 *
 * @param {Object} params
 ...
 * @param {string} [scope] - Optional scope for refresh.
 * @param {Object} [logger] - Optional logger.
 * @returns {Promise<{accessToken: string, refreshToken: string, idToken?: string, claims?: Object, expiresIn?: number}>} Normalised token object.
